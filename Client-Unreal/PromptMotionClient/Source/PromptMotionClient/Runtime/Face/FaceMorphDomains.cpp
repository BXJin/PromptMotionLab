...
{
    // CC4 V_* viseme morphs + jaw/mouth helpers used by lip-sync tuning.
    ...
    static const TSet<FName> Domain = []()
    {
        ...
        D.Add(TEXT("Mouth_Contract"));
        D.Add(TEXT("Mouth_Down"));
        D.Add(TEXT("Mouth_Shrug_Lower"));
        D.Add(TEXT("Mouth_Shrug_Upper"));
        D.Add(TEXT("Mouth_Up"));
        D.Add(TEXT("V_Open"));
        D.Add(TEXT("V_Wide"));
        D.Add(TEXT("V_Tight"));
        D.Add(TEXT("V_Tight_O"));
        D.Add(TEXT("V_Dental_Lip"));
        D.Add(TEXT("V_Affricate"));
        D.Add(TEXT("V_Explosive"));
        D.Add(TEXT("V_Bilabial"));
        D.Add(TEXT("V_Lip_Open"));
        D.Add(TEXT("V_Tongue_Out"));
        D.Add(TEXT("V_Tongue_Raise"));
        D.Add(TEXT("V_Tongue_up"));
        D.Add(TEXT("V_Tongue_Lower"));
        D.Add(TEXT("V_Tongue_Narrow"));
        D.Add(TEXT("V_Tongue_Curl_D"));
        D.Add(TEXT("V_Tongue_Curl_U"));
        return D;
    }();
    return Domain;
}
...
{
    // Owned by FFaceIdleLayer. Expression presets must not drive blink morphs.
    static const TSet<FName> Domain = []()
    {
        TSet<FName> D;
        D.Add(TEXT("Eye_Blink_L"));
        D.Add(TEXT("Eye_Blink_R"));
        return D;
    }();
    return Domain;
}
